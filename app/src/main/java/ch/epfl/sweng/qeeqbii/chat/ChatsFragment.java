...
//ATTENTION JE GARDE LA MEME LAYOUT
                Chats.class,
            ...
            @Override
            protected void populateViewHolder(final ChatsViewHolder ChatsViewHolder, Chats chat, int i) {

                ChatsViewHolder.setDate(chat.getDate());
